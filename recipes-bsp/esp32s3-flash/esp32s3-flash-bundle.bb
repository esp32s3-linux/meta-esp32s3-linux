...
do_compile[noexec] = "1"
do_deploy[depends] += "esp-hosted-firmware:do_deploy virtual/kernel:do_deploy esp32s3-minimal-image:do_deploy esp32s3-etc-image:do_deploy esp32s3-data-image:do_deploy"
